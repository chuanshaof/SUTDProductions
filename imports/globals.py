def initialize():
    global WAIT_CODE, START, PROJECT_NAME, PROJECT_DESCRIPTION, PROJECT_POC, PROJECT_VENUE, PROJECT_PARTNERS, \
        PROJECT_INSPIRATION, PROJECT_ROLES, PROJECT_DEADLINE, PROJECT_REQUIREMENTS, PROJECT_TEAM, PROJECT_CONFIRM, \
        REMOVE, ANNOUNCE_QUERY, ANNOUNCE, EDIT, EDIT_CONFIRM, VIEW_PROJECTS
